...
from models.unconditional_gan import Generator, Discriminator, weights_init
from plot_unconditional_numbers import plot_results
...
def train_unconditional_GAN(n_epochs, batch_size, real_label, num_classes,
          adversarial_loss, device, optimizer_G, optimizer_D,
          generator, discriminator, dataloader_train, dataloader_test, loss_filename, evolution_loss_filename):
    ...
    for epoch in range(n_epochs):
        ...
        for i, (imgs, label_num) in enumerate(dataloader_train, 0):
            ...
            real_output = discriminator(real_imgs, real_labels).view(-1)
        ...
        if (epoch % 5 == 0):
            ...
            fname = "logs/results_unconditional_gan/dataset_im_epoch" + str(epoch) + ".png"
            plot_results(fname, real_imgs, real_labels, fake, fixed_labels)

            gen_checkpoint_filename = f"logs/uncond_generator.epoch_{epoch}.pth"
            det_checkpoint_filename = f"logs/uncond_discriminator.epoch_{epoch}.pth"
...
if __name__ == '__main__':
    ...
    loss_filename = "loss_unconditional_gan.txt"
    evolution_loss_filename = "evolution_loss_unconditional_gan.txt"
    ...
    fname = "logs/results_unconditional_gan/dataset_im_start.png"
    ...
    generator,  discriminator = \
            train_unconditional_GAN(n_epochs, batch_size, real_label, num_classes,
            adversarial_loss, device, optimizer_G, optimizer_D,
